  ...
  class Account
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LeanixMtmApi::Account` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LeanixMtmApi::Account`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'responsible_user')
        self.responsible_user = attributes[:'responsible_user']
      end
    ...
    def valid?
      ...
      password_policy_validator = EnumAttributeValidator.new('String', ["NORMAL", "STRICT"])
      return false unless password_policy_validator.valid?(@password_policy)
      true
    end
    ...
    # @param [Object] password_policy Object to be assigned
    def password_policy=(password_policy)
      validator = EnumAttributeValidator.new('String', ["NORMAL", "STRICT"])
      unless validator.valid?(password_policy)
        fail ArgumentError, "invalid value for \"password_policy\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          links == o.links &&
          responsible_user == o.responsible_user &&
    ...
    def hash
      [id, name, from_address, links, responsible_user, password_policy].hash
    end
